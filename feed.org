...
#+include: articles/2020/musical-goals.org src :lines "2-"
* Dark Mode                                                           :Hacks:
:PROPERTIES:
...
#+include: articles/2020/dark-mode.org src :lines "2-"
...
#+include: articles/2020/driving-technical-change.org src :lines "2-"
...
* Speeding up tests on CircleCI for a Python Django project :Python:CircleCI:
  ...
  #+include: articles/2019/speed-up-circleci.org src :lines "2-"
...
* Digital Minimalism                                      :Lifestyle:Reviews:
  ...
  #+include: articles/2019/digital-minimalism.org src :lines "2-"
...
* Learning Guitar Update                                              :Music:
  ...
  #+include: articles/2019/learning-guitar-update.org src :lines "2-"
...
* Bose QuietComfort 35 Review                                       :Reviews:
  ...
  #+include: articles/2019/bose-quietcomfort-35-review.org src :lines "2-"
* Musical Goals January Update                                        :Music:
  ...
  #+include: articles/2019/musical-goals-january-update.org src :lines "2-"
* My Musical Goals for 2019                                           :Music:
  ...
  #+include: articles/2019/musical-goals-for-2019.org src :lines "2-"
...
* Extracting Minecraft Music with Python                   :Minecraft:Python:
  ...
  #+include: articles/2018/minecraft-music-extractor.org src :lines "2-"
